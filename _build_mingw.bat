...
call "%~dp0_build.bat" mingw %config% x86 unicode || exit /b !errorlevel!
call "%~dp0_build.bat" mingw %config% x86 ansi    || exit /b !errorlevel!
call "%~dp0_build.bat" mingw %config% x64 unicode || exit /b !errorlevel!
