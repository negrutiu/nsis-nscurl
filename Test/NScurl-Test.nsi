...
Section "Big file (10GB)"
	...
	NScurl::http GET "${LINK}" "${FILE}" /STRING TEXT "[@PERCENT@%] @TIMEELAPSED@ / @TIMEREMAINING@, @XFERSIZE@ / @FILESIZE@, @SPEED@" /INSIST /RESUME /CANCEL /TIMEOUT 1m /TITLEWND $HWNDPARENT /END
	Pop $0
	DetailPrint "Status: $0"
